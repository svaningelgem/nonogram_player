...
max_guess_accumulator_array_threshold = (
    100  # minimum of 1, no maximum, (max 300?) the quantity of votes
)
...
for cir, guess_dp, guess_accumulator_array_threshold, guess_radius in circleLog:
    ...
    print(
        f" >> {counter}: {guess_dp}, {guess_accumulator_array_threshold}, {guess_radius}"
    )
    counter += 1
